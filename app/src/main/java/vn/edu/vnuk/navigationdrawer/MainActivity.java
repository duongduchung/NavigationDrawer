...
//                    .replace(R.id.fragment_container,rssFragment).commit();
            ...
            Intent news = new Intent(MainActivity.this,Kenh14.class);
            startActivity(news);
        }else if (id == R.id.nav_send2) {
            Intent news = new Intent(MainActivity.this,BaoBongDa.class);
            startActivity(news);
        }else if (id == R.id.nav_send3) {
            Intent news = new Intent(MainActivity.this,GenK.class);
            startActivity(news);
        }
